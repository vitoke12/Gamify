...
export const CATEGORIAS: DefCategoria[] = [
  ...
  { key: 'emocional', nombre: 'Emocional', esfera: 'interior', icono: 'heart-pulse', orden: 3, activa: false },
  { key: 'social', nombre: 'Social', esfera: 'expresion', icono: 'users', orden: 4, activa: false },
  { key: 'profesional', nombre: 'Profesional', esfera: 'expresion', icono: 'briefcase', orden: 5, activa: false },
  { key: 'creativo', nombre: 'Creativo', esfera: 'expresion', icono: 'palette', orden: 6, activa: false },
  { key: 'aventura', nombre: 'Aventura', esfera: 'expresion', icono: 'compass', orden: 7, activa: false },
  { key: 'habitos', nombre: 'Hábitos', esfera: 'base', icono: 'sunrise', orden: 8, activa: true },
  { key: 'financiero', nombre: 'Financiero', esfera: 'base', icono: 'piggy-bank', orden: 9, activa: false },
